...
namespace RosettaUI.Example
{
    public class ArgumentExample : MonoBehaviour, IElementCreator
    {
        ...
        {
            return ExampleTemplate.CodeElementSetsTab("Custom Label",
        ...
        {
            return ExampleTemplate.CodeElementSetsTab("No Label",
        ...
        {
            return ExampleTemplate.CodeElementSetsTab("Expression",
